...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // src/hooks/increment.ts
  init_react_shim();
  var import_react = __toModule(require_react());
  var useIncrement = () => {
    const [counter, setter] = (0, import_react.useState)(0);
  ...
  var Hello = ({ name }) => {
    ...
    increment();
    return /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("span", null, "Hello, "), /* @__PURE__ */ React.createElement("span", null, count, "\u56DE\u76EE\u306E", name));
  };

  // src/index.tsx
  var root = document.querySelector("#root");
  (0, import_react_dom.render)(/* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Hello, {
    name: "You"
  })), root);
})();
/*
